 ...
 * This file demonstrates how to integrate Bridgetoken with a web frontend
 */

// For React/Vue/Angular applications
export class BridgetokenClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BridgetokenClient(provider, contractAddress);
