...
const contractABI = require("../artifacts/contracts/Bridgetoken.sol/Bridgetoken.json").abi;

program
    .name("bridgetoken-cli")
    .description("CLI tool for Bridgetoken smart contract")
    .version("1.0.0");
